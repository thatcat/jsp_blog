...
The blog deployed in [http://www.chenxiusheng.cn](http://www.chenxiusheng.cn) ,but I change the website
...
+JavaBean+Servlet的设计流程是怎样的，就不想白白浪费了自己断断续续做了两个月的成果，把这个JSP博客放到了这里。
