<%@ page language="java" import="java.util.*,com.xiuson.valuebean.*"
	pageEncoding="UTF8"%>
<%
			...
			<table border="1" width="80%" bgcolor="Olive">
				...
				<tr>
					...
					<td align="center" valign="top">
						...
						<table>
													<tr>
							<td align="center" ><h2>博主有:<h1><%=friendList.size() %></h1>位好友.快把你的博客告诉他</h2></td>
							</tr>
						</table>
						
						
						<table width="100%" height="200" border="1">
						<th>博客名</th><th>博客地址</th>
							<%
							...
							<tr>
								...
								<td >
									<a href="<%=friendBean.getLink()%>"><%=friendBean.getLink()%></a>
								</td>
							</tr>
							<%
								i++;
