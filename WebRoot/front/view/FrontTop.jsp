...
<html>
  ...
  <body >
 	...
 	<h3>
 	<%=myAtriclePercent %>%的人对【我的文章】感兴趣 <br><%=myFriendPercent %>%的人对【我的好友】感兴趣 <br> <%=myWordPercent %>%的人对【给我留言】感兴趣<br>
 	</h3>
 	</div>
  ...
  <table width="100%" height="40%" bgcolor="aabbaa" align="center" cellspacing="20%">
 <tr>
