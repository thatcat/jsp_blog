  ...
  <tr>
        ...
        <tr height="15"><td></td></tr> 		
  		...
  		while (i < wordList.size()) {
  		 ...
  		 %>
  		 <tr><td style="text-indent:20">【<%=wordSingle.getId() %>】<b><%=wordSingle.getAuthor() %></b></td></tr>
  		 <tr align="right" ><td><%=wordSingle.getSdTime() %> &nbsp;&nbsp;</td></tr>
  		 <tr><td colspan="2" valign="top" > <%=wordSingle.getContent() %></td></tr>
  		 <tr height="1"><td background="image/line.jpg" colspan="2"></td></tr>
  		<%
  		i++;
  		}
  		out.println("</table>");
  		...
  		for(int i = 0;i < (Integer.parseInt(wordSum)+9)/10 ; i++) {		 
  		 %>
  		 <a href="WordServlet?action=readWord&wordBegin=<%=i+1%>&count=<%=10%>"><%=i+1 %></a>
  		 <%if(i!=0 && i%10 == 0) 
  		      out.println(" <br/>");%>
