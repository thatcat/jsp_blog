...
<html>
 ...
 messages = "";
  ...
  <table  align="center" width="50" ><!-- 大表格 -->
  	<tr>
  		<td align="center">
  		<table border="0" style="margin-top:300" align="center" width="50"><!-- 小表格 -->
  		<form action="LogonServlet?action=logon" method="post" >
  		<tr><td colspan="2" align="center"><%=messages %></td></tr>
  		<tr height="30">
  		<td>用户名</td>
  		...
  		<td></td>
  		<td>
  		<input type="submit" class="btn_bg" value="登陆"/>
