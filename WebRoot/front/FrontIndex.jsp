...
<html>
  <head>
    ...
    <title>@秀升xiuson的一些事一些情 的 博客(beta)</title>
  ...
  <!-- 包含头文件 -->
  <tr> <td colspan="20" ><jsp:include page="view/FrontTop.jsp"/></td></tr>
  <tr>
  		<!-- 包含侧栏文件 -->
  		...
  		if(articleList == null || articleList.size() == 0  ) {
  		 %>
  		<tr height="100" ><td align="center">博主还没有发表文章！</td></tr>
  		<%
  		}
  		else {
  		int i= 0;
  		...
  		<td class="tdg" style="text-ident:20" colspan="2">
  		    ...
  		    <tr height="300"><td colspan="200"></td></tr>
  		    <%
  		    i++;
  		    }
  		    }
